    ...
    },
    {
      ...
      render: (_: any, record: Bill) => (
        <Space size="small">
          ...
          {record.paymentStatus === 'PENDING' && record.paymentType === 'ONLINE' && (
            <Button
              type="primary"
              size="small"
        ...
        {selectedBill && (
          <Descriptions column={2} bordered>
            ...
            <Descriptions.Item label="Tax">
              Rs. {(selectedBill.tax || 0).toFixed(2)}
            </Descriptions.Item>
              ...
              <Form.Item style={{ marginBottom: 0, textAlign: 'right' }}>
                <Space>
                  ...
                  <Button 
                    ...
                    icon={<CreditCardOutlined />}
                  >
                    {processingPayment ? 'Processing...' : `Pay Rs. ${selectedBill.totalAmount.toFixed(2)}`}
                  </Button>
                </Space>
              </Form.Item>
            </Form>
